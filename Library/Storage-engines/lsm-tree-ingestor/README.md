...
* **Tombstone Concept (Planned):** The design anticipates handling deletions as "tombstone" writes to maintain high write speeds even for delete-heavy workloads; the current `MemTable` implementation does not yet include delete/tombstone support.
